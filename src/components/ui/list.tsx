    ...
    return (
      ...
      >
        {React.Children.map(children, (child, index) => {
          ...
          return <li className={cn(dividers && index !== 0 && "border-t border-gray-200 pt-2")}>{child}</li>;
        })}
      </Component>
    );
  }
...
const ListItem = React.forwardRef<HTMLLIElement, ListItemProps>(({ className, icon, children, ...props }, ref) => (
